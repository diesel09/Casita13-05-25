...
_globales=$(curl -sSL "https://movie.angelcampos.xyz/testgen/CHUMODGATESCCN/source/Control-Bot.txt" | cut -d '|' -f1)
permited=$(curl -sSL "https://movie.angelcampos.xyz/testgen/CHUMODGATESCCN/source/Control-Bot.txt") 
