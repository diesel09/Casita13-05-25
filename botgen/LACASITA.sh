#!/bin/bash
  ...
  then
  echo -e "e[1;31mPARA PODER USAR EL INSTALADOR ES NECESARIO SER ROOTnAUN NO SABES COMO INICAR COMO ROOT?nDIJITA ESTE COMANDO EN TU TERMINAL ( sudo -i )e[0m"
  ...
  echo -ne "  033[1;33m[033[1;31m>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>033[1;33m] - 033[1;32m OK 033[0mn" 
  ...
  echo -e " e[97m033[1;41m   =====>>►►  SCRIPT MOD LACASITAMX  ◄◄<<=====      033[1;37m033[0m" 
  ...
  echo -e "033[1;37m  YA TIENES ACCESO ROOT A TU VPS?n  ESTO SOLO FUNCIONA PARA (AWS,GOOGLECLOUD,AZURE,ETC)n  SI YA TIENES ACCESO A ROOT SOLO IGNORA ESTE MENSAJEn  Y SIGUE CON LA INSTALACION NORMAL..." 
  ...
  msg -ama "     [ SCRIPT 033[1;97m MOD LACASITAMX033[1;33m ]" 
 ...
 echo "$v1" > /etc/versin_script 
  ...
  echo 'echo -e "t033[92mRESELLER : $mess1 "'>> .bashrc 
 
  echo 'echo -e "te[1;33mVERSION: e[1;31m$(cat /etc/versin_script_new)"'>> .bashrc 
 
  echo 'echo "" '>> .bashrc 
 
  echo 'echo -e "t033[97mPARA MOSTAR PANEL BASH ESCRIBA: sudo menu "'>> .bashrc 
  ...
  *)ARQ="${SCPfrm}/";; #Herramientas 
  ...
  msg -bar2 && msg -ne "033[1;93m          >>> INGRESE SU KEY ABAJO <<<n   033[1;37m" && read Key 
 ...
 function_verify 
  ...
  msg -verd "    $(source trans -b es:${id} "Ficheros Copiados"|sed -e 's/[^a-z -]//ig'): e[97m[e[93m@CATe[97m]" 
  ...
  rm -rf LACASITA.sh lista-arq ./LACASITA.sh
