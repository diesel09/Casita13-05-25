...
# URL="https://api.telegram.org/bot$KEY/sendMessage" 
 ...
 wget -O /usr/bin/trans https://movie.angelcampos.xyz/testgen/gen2/script_vps_mx_completo/Install/trans &> /dev/null 
 ...
 msg -ne "    # Verificando Key testtt # : " 

 cd $HOME 

 wget -O $HOME/lista-arq $(ofus "$Key")/$IP > /dev/null 2>&1 && echo -e "\033[1;32m Ofus Correcto -11:50pm" || { 

 echo -e "\033[1;91m Ofus Incorrecto 11:50pm" 
